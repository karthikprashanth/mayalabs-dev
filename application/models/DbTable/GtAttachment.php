...
class  Model_DbTable_GtAttachment extends Zend_Db_Table_Abstract  {
    ...
    */
	...
	/**
	 * Id of the gasturbine to which this attachment belongs
	 */
	protected $gtId;
    ...
    public static function getList($options = array()){
        ...
        if(count($options)){
            ...
            $query = "SELECT * FROM gt_attachment " . $where . " " . $order;
     ...
     *
     * @param Integer $gtId - Optional parameter to delete the attachments belonging to a particular gtdata
     */
    public function deleteGTAttachment($gtId){
        if(!$gtId){
